...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var nextApp, nextAppHandler, app, config;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    nextApp = (0, next_1.default)({ dev: false });
                    return [4 /*yield*/, nextApp.prepare()];
                case 1:
                    _a.sent();
                    nextAppHandler = nextApp.getRequestHandler();
                    app = new koa_1.default();
                    config = (0, config_1.default)();
                    console.log("config >>>>>>>>>>>", config);
                    app.use((0, koa_mount_1.default)('/', function (ctx) {
                        ctx.respond = false;
